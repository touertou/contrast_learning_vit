...
parser.add_argument(
    ...
    '--input_dir',
    type=str,
    default='../data/data_synapse/testdata_npz/imgs/',
    # default='data/npz/LiteMedSAM_test/CT_Abd/',
...
parser.add_argument(
    ...
    '--output_dir',
    type=str,
    default='../synapse_result/infer_tinyvit/mse_mse+0.1triplet_patch/segs22/',
    # default='test_demo/tinyvit_100eopch/segs/',
    help='directory to save the prediction',
)
parser.add_argument(
    '-lite_medsam_checkpoint_path',
    type=str,
    # default="workdir/LiteMedSAM_lr0.0005_epoch200/medsam_lite_best_model.pth",
    default="checkpoint/LiteMedSAM/lite_medsam.pth",
    #default="../synapse_result/distill_tinyvit/mse/lite_TransSC_medsam.pth",
...
parser.add_argument(
    '-png_save_dir',
    type=str,
    default='../synapse_result/infer_tinyvit/lite_medsam/png',
    # default='./overlay/tinyvit',
