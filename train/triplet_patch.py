...
# 输入图片标签大小1024*1024，分割成 16 x 16 的 patch 块，则有(1024/16)*(1024/16)=64*64=4096个patch
# 相似度矩阵similarity_matrix是为4096*4096。用于存储4096个patch两两之间的相似度
# 相似度矩阵similarity_matrix是在图片标签的基础上构造的

# 定义路径
input_dir = '../../data/data_synapse/npy/train/gts/'
positive_output_dir = '../../data/data_synapse/npy/label/positive_index'
negative_output_dir = '../../data/data_synapse/npy/label/negative_index'
...
for filename in os.listdir(input_dir):
    if filename.endswith('.npy'):
        ...
        # print(
        #     f"Processed {filename}: positive saved to {positive_output_path}, negative saved to {negative_output_path}")

# positive_index_path = '../../data/npy_medsam/CT_Abd/label_gts/positive_index/CT_Abd_FLARE22_Tr_0001-049.npy'
# positive_index = np.load(positive_index_path)
